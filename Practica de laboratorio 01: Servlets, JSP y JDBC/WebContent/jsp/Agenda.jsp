...
<body>
	...
	<header>
		...
		<nav
			...
			<form class=" nav navbar-nav nav-flex-icons ml-auto mr-sm-2">
				<a href="Agenda?logout=true" class="btn  btn-block"
					style="color: white; font-size: 15px;" type="submit" name="accion"
	...
	<div class="container">
		<c:choose>
			<c:when test="${user.telefono.size() > 0}">
				...
				<button type="button"
					class="ubtn btn-primary btn-lg btn blue-gradient"
					data-toggle="modal" data-target="#AddPhone"
					style="font-size: 13px;">
					<i style="font-size: 13px;" class="fas fa-plus-circle"></i> Add
					Phone
				</button>
				...
				<form
					...
					style="width: 280px;"
					action="/Practica_de_laboratorio_01_Servlets_JSP_y_JDBC/Agenda">
					<i class="fas fa-search" aria-hidden="true"
						style="color: white; font-size: 20px;"></i> <input
						class="form-control form-control-sm ml-3 w-75" type="text"
						name="buscarNumero" placeholder="Search by numer"
						aria-label="Search" id="buscarNumero"
						...
						<tbody>
							<tr>
								...
								<td>
										...
										<div class="modal-dialog">
											<div class="modal-content"
												...
												<div class="modal-header">
													<h5 class="h5"
														style="font-family: 'Kaushan Script', cursive; font-size: 27px; color: white;">Eliminar
														numero</h5>
												...
												<div class="modal-body">
													<p class="card-text"
														...
														${telefono.numero} Esta por eliminar de tu angeda.</p>
												</div>
												<div class="modal-footer ">

													<a
														href="/Practica_de_laboratorio_01_Servlets_JSP_y_JDBC/EditPhone?delete=true&idTel=${telefono.codigo}"
														class="btn tempting-azure-gradient btn-ok"><i
														class="fas fa-trash-alt" style="font-size: 17px;"></i></a>
												</div>
											</div>
										</div>
									...
									<div class="btn blue-gradient" data-toggle="modal"
										data-target="#editar${i}">
										<i class="fas fa-edit"></i>
									</div>

									<div class="btn btn-primary btn-danger" data-toggle="modal"
						...
						<div class="modal fade" id="editar${i}" tabindex="-1"
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content"
									...
									<form
										action="/Practica_de_laboratorio_01_Servlets_JSP_y_JDBC/EditPhone"
										method="POST">
										...
										<div class="modal-footer">
											...
											<button type="submit" class="btn near-moon-gradient"
												style="font-size: 11px;">
												<i class="fas fa-cloud" style="font-size: 11px;"></i> Save
											</button>
										</div>
									</form>
								</div>
	...
	<c:otherwise>
		<section class="row">
			...
			<h1 class="cl-md-12 ">POR EL MOMENTO NO EXISTEN CONTACTOS</h1>


		</section>

		<button type="button"
			class="ubtn btn-primary btn-lg btn blue-gradient" data-toggle="modal"
	...
	<div class="modal fade" id="AddPhone" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content"
				...
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalCenterTitle"
						style="color: white; font-size: 27px; font-family: 'Kaushan Script', cursive;">Añadir
						Celular</h5>
				</div>

				<form
					action="/Practica_de_laboratorio_01_Servlets_JSP_y_JDBC/AgregarPhone"
					method="POST">
